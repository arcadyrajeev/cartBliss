    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          className="fixed top-[10%] z-99 lg:hidden flex flex-col w-full h-[100dvh] bg-white px-4 pb-4 space-y-2"
        >
          <a
            href="/product"
            className="block text-[2.6rem] border-b font-medium text-black hover:text-gray-600"
          >
            Product
          </a>
          <a
